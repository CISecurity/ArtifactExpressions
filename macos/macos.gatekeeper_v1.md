...
| ----------------------|--------| ----------- |
| gatekeeper | String | macos.gatekeeper_v1 is a singleton and is effectively unused and not needed.  Artifact Types required a parameter in Workbench in the past. |
...
| enabled | Boolean | The status of Gatekeeper assessments.|
