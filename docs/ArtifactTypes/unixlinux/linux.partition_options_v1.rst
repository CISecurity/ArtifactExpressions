...
The Linux: Partition Options test is used to check the information associated with partitions on the local system. 
...
.. table:: linux.partition_options_v1_parameters
   :widths: 33, 8, 33
=================================  ========  =================================
