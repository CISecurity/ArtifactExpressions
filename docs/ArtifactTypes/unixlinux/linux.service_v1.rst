...
The Linux: Service test retrieves information about systemd units in the form of properties. For more information see the output generated by systemctl show $unit. The test references the required systemdunitproperty_object and the state element specifies the information to check. 
...
.. table:: linux.service_v1_parameters
   :widths: 33, 8, 33
=================================  ========  =================================
