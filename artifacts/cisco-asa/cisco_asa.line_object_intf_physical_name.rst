...
The Cisco ASA: Line Object With Interface Physical Name test is used to check the properties of specific output lines from a SHOW command, such as SHOW RUNNING-CONFIG.
