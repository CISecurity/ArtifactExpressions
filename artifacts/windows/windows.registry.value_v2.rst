Windows: Registry Value V2
==========================

Description
-----------

The Windows: Registry Value V2 test is used to check metadata associated with Windows registry key. 
...
NOTE: The ``name_operation`` parameter is governed by a constraint allowing only the following values:
  - equals
  - not equal
