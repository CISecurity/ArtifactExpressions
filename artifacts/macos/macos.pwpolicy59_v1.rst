...
|                               |         | be collected.                    |
+-------------------------------+---------+----------------------------------+
:strong:`NOTE: The` ``target_user``, ``username``, ``userpass``, :strong:`and` ``directory_node`` `parameters are governed by a constraint allowing only values conforming to the following regex pattern:` ``^.+$``
