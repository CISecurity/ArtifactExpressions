...
For ``vmware.vmhost_vswitchpolicy_v2`` ``vmware.vmhost_vswitchpolicy_v2`` artifacts, the XCCDF check looks like this. There is no Value element in the XCCDF for this artifact.
