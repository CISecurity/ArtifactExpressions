...
For ``vmware.vmhost_ntpserver_v2`` ``vmware.vmhost_ntpserver_v2`` artifacts, the XCCDF check looks like this. There is no Value element in the XCCDF for this artifact.
...
For ``vmware.vmhost_ntpserver_v2`` ``vmware.vmhost_ntpserver_v2`` artifacts, the XCCDF check looks like this.
