...
For ``vmware.vmhost.acceptance_level`` ``vmware.vmhost.acceptance_level`` artifacts, the XCCDF check looks like this. There is no Value element in the XCCDF for this artifact.
