...
For ``vmware.vm_harddiskdevice_v2`` ``vmware.vm_harddiskdevice_v2`` artifacts, an XCCDF Value element is generated.
...
For ``vmware.vm_harddiskdevice_v2`` ``vmware.vm_harddiskdevice_v2`` artifacts, the XCCDF check looks like this.
