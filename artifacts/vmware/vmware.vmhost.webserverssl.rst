...
For ``vmware.vmhost.webserverssl`` ``vmware.vmhost.webserverssl`` artifacts, an XCCDF Value element is generated.
...
For ``vmware.vmhost.webserverssl`` ``vmware.vmhost.webserverssl`` artifacts, the XCCDF check looks like this.
