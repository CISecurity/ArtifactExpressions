...
~~~~~~~~~~~~~~~~~~~~
  ...
  - vmware:vmhost_coredump_network_server_ip

Test Type Parameters
~~~~~~~~~~~~~~~~~~~~

**vmware.vmhost_coredump_network_server_ip_v2**
...
For ``vmware.vmhost_coredump_v2`` ``vmware.vmhost_coredump_network_server_ip_v2`` artifacts, an XCCDF Value element is generated.
...
For ``vmware.vmhost_coredump_v2`` ``vmware.vmhost_coredump_network_server_ip_v2`` artifacts, the XCCDF check looks like this.
