...
For ``unix.chkconfig_service_v1`` ``unix.service_enabled_v1`` artifacts, the XCCDF check looks like this. There is no Value element in the XCCDF for this artifact.
