...
The required systemdunitdependency_object element is used to define the specific units to check the dependencies of.

The optional systemdunitdependency_state element holds dependencies of a specific systemd unit. 
...
.. table:: linux.systemd_unit_dependency_v1_parameters
   :widths: 33, 8, 33
=================================  ========  =================================
Name                               Type      Description  
=================================  ========  =================================
unit                               string    The full systemd unit name, usually also the filename of the unit configuration file located in the /etc/systemd/ and /usr/lib/systemd/ directories.
...
Name                               Type      Description  
=================================  ========  =================================
unit                               string    The full systemd unit name, usually also the filename of the unitconfiguration file located in the /etc/systemd/ and /usr/lib/systemd/ directories.
