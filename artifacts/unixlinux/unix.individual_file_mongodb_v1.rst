Unix: Individual File  MongoDB V1
===================================
...
For ``unix.individual_file_ MongoDB_v1`` artifacts, an XCCDF Value element is generated.
...
For ``unix.individual_file_ MongoDB_v1`` artifacts, the xccdf:check looks like this.
