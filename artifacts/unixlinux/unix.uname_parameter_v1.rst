...
.. table:: unix.uname_parameter_v1_parameters
   :widths: 33, 8, 33  
=================================  ========  =================================
...
NOTE: The ``parameter`` parameter is governed by a constraint allowing only
