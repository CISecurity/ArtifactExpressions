...
.. table:: unix.symlink_v1_parameters
   :widths: 33, 8, 33   
=================================  ========  =================================
Name                               Type      Description  
=================================  ========  =================================
filepath                           string    Specifies the filepath for the symbolic link.
filepath_operation                 string    Specifies what operation is to be performed using the filepath value.
=================================  ========  =================================
...
filepath                           string    Specifies the filepath for the symbolic link.
filepath_operation                 string    Specifies what operation is to be performed using the filepath value.
canonical_path                     string    Specifies the canonical path for the target of a symbolic link file specified by the filepath.
canonical_path_operation           string    Specifies what operation is to be performed using the canonical path value.
=================================  ========  =================================
...
.. table:: unix.symlink_password_object_v1_parameters
   :widths: 33, 8, 33  
=================================  ========  =================================
Name                               Type      Description  
=================================  ========  =================================
filepath                           string    Specifies the filepath used to create the object.
filepath_operation                 string    Specifies what operation is to be performed using the filepath value.
canonical_path                     string    Specifies the canonical path for the target of a symbolic link file specified by the filepath.
canonical_path_operation           string    Specifies what operation is to be performed using the canonical path value.
=================================  ========  =================================
