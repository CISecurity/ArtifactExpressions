...
Description
-----------
The Linux: Upstart Service test executes a shell command and evaluates the lines of output to determine if a service is enabled. 
...
.. table:: linux.upstart_service_v1_parameters
   :widths: 33, 8, 33
=================================  ========  =================================
...
For ``linux.upstart_service_v1`` artifacts, the xccdf:check looks like this.
