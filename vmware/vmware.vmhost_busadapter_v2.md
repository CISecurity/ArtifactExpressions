...
| vmhost_name | String |  The name of the ESXi host to scope collection to. Set to NA if not applicable |
| vmhost_name_operation | String | comparison operation |
| busadapter_type | String | Valid values are Block, FibreChannel, IScsi, and ParallelScsi |
