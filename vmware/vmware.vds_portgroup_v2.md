...
| operation | String | comparison operation |
| datatype | String | datatype |
| collector_port | String | Authorized collector Port to which Virtual Disributed Switch Netflow traffic is sent |
...
| operation | String | comparison operation |
| datatype | String | datatype |
| override_port_policies_enabled | Boolean | Port-level configuration overrides enabled? |
